...
When installing `Visual Studio 2026` (herein referred to as `VS2026`), you will minimally need the following workloads selected:
...
Install the edition of `VS2026` you prefer with the previously mentioned workloads.
...
Select `Build Solution` from the `Build` menu. It should build successfully unless someone broke the branch you're working on or you're missing dependencies.
