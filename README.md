...
[![License](https://img.shields.io/github/license/SpeedRunTool/SRTHost)](https://github.com/SpeedRunTool/SRTHost/blob/main/LICENSE)

A plugin-based application for running various informational speedrun tools.
